...
prepareAndSendServoPWM:
	...
	; poll. the following calculation takes some time.
	movlw 1
	call testRX
...
_pSPsort:
	...
	btfsc STATUS,C
	bra _pSPsort_nswp
	moviw 3[FSR1] ; need to swap these.
	movwf ml_temp3
	moviw 0[FSR1]
	movwi 3[FSR1]
	moviw 1[FSR1]
	...
	movf ml_temp2,0
	movwi 2[FSR1]
	incf l_Bh,1 ; mark there was a swap.
_pSPsort_nswp:
	addfsr FSR1,3
	incf l_Bl,1
	...
	movlw 1
	call testRX
	; if had a swapping, restart loop.
	movf l_Bh,0
	btfss STATUS,Z
	bra _pSPsort0
